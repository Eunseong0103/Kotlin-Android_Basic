...
//val wrongByte : Byte = 1000 -> Byte가 표현할 수 있는 수범위보다 큰 수를 넣은 경우 에러 발생
//val wrongByte : Byte = "안녕하세요" -> 타입 미스매치 에러 발생

val floatNumber: Float = 10.0f // float의 경우에는 할당하는 값뒤에 f를 붙여줘야 한다.
...
//-실제로는 대부분 그냥 Int , Double를 사용한다.

//변수명
//코틀린에서 선점해서 사용하고 있는 키워드는 변수명으로 사용할 수 없다.
